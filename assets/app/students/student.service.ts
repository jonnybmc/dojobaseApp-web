...
export class StudentService {
    ...
    addStudent(student: Student){
        ...
        return this.http.post('http://dojobase-deployment.herokuapp.com/student' + token,body,{headers: headers})
    ...
    getStudents(){
        return this.http.get('http://dojobase-deployment.herokuapp.com/student')
            .map((response:Response) => {
    ...
    getStudent(studentId : string) {
        return this.http.get('http://dojobase-deployment.herokuapp.com/student/' + studentId).map((response:Response) =>{
    ...
    deleteStudent(student: Student) {
        ...
        const token = localStorage.getItem('token') ? '?token=' + localStorage.getItem('token') : '';
        return this.http.delete('http://dojobase-deployment.herokuapp.com/student/' + student.studentId + token)
    ...
    updateStudent(student:Student){
        ...
        const token = localStorage.getItem('token') ? '?token=' + localStorage.getItem('token') : '';
        return this.http.patch('http://dojobase-deployment.herokuapp.com/student/' + student.studentId + token,body, {headers : headers})
            .map((response: Response) => response.json())
            .catch((error: Response) => {
                this.errorService.handleError(error.json());
                return Observable.throw(error.json());
